...
@section('js_after')
    ...
    <script>
        $('#borrar').on('show.bs.modal', function (event) {
            $("#borrarForm").attr('action','{{ url('/cms/articulo/eliminar') }}');
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                <button type="button" class="btn-block-option mr-2"><a href="{{ URL::to('cms/articulo/nuevo') }}"><i class="fa fa-plus mr-1"></i> Nuevo</a></button>
        ...
        <form action="{{ url('/cms/articulo') }}" method="get">
            <div class="row">
            ...
            <table class="table table-bordered table-striped table-vcenter">
                ...
                <tbody>
                @foreach($tab_articulo as $key => $value)
                    <tr>
                        ...
                        <td class="d-none d-sm-table-cell">
                            ...
                            <a href="{{ url('/cms/articulo/despublicar').'/'. $value->id }}">
                                <i class="fa fa-eye text-done mr-1"></i>
                            </a>
                            @else
                            <a href="{{ url('/cms/articulo/publicar').'/'. $value->id }}">
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="{{ url('/cms/articulo/editar').'/'. $value->id }}">
                                ...
                                @if ($value->id != $maximo)
                                <button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Subir" onclick="location.href='{{ url('/cms/articulo/arriba').'/'. $value->id }}'">
                                ...
                                @endif
                                @if ($value->id != $minimo)
                                <button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Bajar" onclick="location.href='{{ url('/cms/articulo/abajo').'/'. $value->id }}'">
            ...
            {{ $tab_articulo->appends(Request::only(['perPage','q']))->render() }}         
