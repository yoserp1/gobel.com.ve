                ...
                <div class="row justify-content-center push">
                    <div class="col-md-10">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control {!! $errors->has('contenido') ? 'is-invalid' : '' !!}" id="contenido" name="contenido" rows="3" placeholder="Contenido.." {{ $errors->has('contenido') ? 'aria-describedby="contenido-error" aria-invalid="true"' : '' }}>{{ old('contenido') }}</textarea>
